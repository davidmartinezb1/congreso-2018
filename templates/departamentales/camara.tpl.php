...
//$origen="/var/www/html/desarrollos/drupaltest/sites/default/files/elecciones/xml/BOL_CAM_DE000_0012.xml";
$xml2= new SimpleXMLElement($origen, null, true);

//print "<pre>".print_r($xml2->Boletin[1],1).print"</pre>";
...
$depto=array();
    ...
    foreach ($xml->Detalle_Circunscripcion->lin->Detalle_Candidato->lin as $candidato) {      
        if((string)$candidato->Candidato["V"]!="000"){
            $tcandidato[$c]=array(
    ...
    $data[$depto[$a]]=array();
    $data[$depto[$a]]['data']['lugar']=$n_depto;// nombre la capital
    ...
    print "Procesando Boletin N°".$n_boletin.",CAMARA:".$n_depto."<hr><br>";
    $a++;
...
$nameFile="camara_departamental.json";
