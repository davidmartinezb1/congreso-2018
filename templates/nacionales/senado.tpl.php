...
//$origen="/var/www/html/desarrollos/drupaltest/sites/default/files/elecciones/xml/BOL_SEN_00000_0021.xml";
...
foreach ($xml2 as $key => $xml) {
    ...
    $n_depto=(string)$xml->Tipo_Boletin["V"]; 
    ...
    print "Procesando Boletin N°".$n_boletin.",SENADO ".$n_depto."<hr><br>";
    $a++;
}

$json_string=json_encode($data);
$path = DRUPAL_ROOT . "/sites/default/files/elecciones/json/";
$nameFile="senado_nacional.json";
