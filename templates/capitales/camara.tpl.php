<?php 
//$origen="/var/www/html/desarrollos/drupaltest/sites/default/files/elecciones/xml/BOL_CAM_CA000_0012.xml";
...
foreach ($xml2 as $key => $xml) {
    ...
    print "Procesando Boletin N°".$n_boletin.",CAMARA:".$n_depto.":".$n_capital."<hr><br>";
    $a++;
}
...
$nameFile="camara_capitales.json";
